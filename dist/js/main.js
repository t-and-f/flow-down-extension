...
/* harmony import */ var _lib_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/ui */ "./src/lib/ui.js");
/* harmony import */ var _lib_viewsFactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/viewsFactory */ "./src/lib/viewsFactory.js");
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
/* harmony import */ var _views_notfound_tpl_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../views/notfound.tpl.html */ "./src/views/notfound.tpl.html");
/* harmony import */ var _views_notfound_tpl_html__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_views_notfound_tpl_html__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _views_statetree_tpl_html__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../views/statetree.tpl.html */ "./src/views/statetree.tpl.html");
/* harmony import */ var _views_statetree_tpl_html__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_views_statetree_tpl_html__WEBPACK_IMPORTED_MODULE_5__);
 // Libs
...
chrome.devtools.panels.create("FlowDown", "", "panel.html", function (panel) {
  ...
  panel.onShown.addListener(function (devpane) {
    ...
    var ui = new _lib_ui__WEBPACK_IMPORTED_MODULE_1__["default"]($('.display')[0]);
    var notfoundView = _lib_viewsFactory__WEBPACK_IMPORTED_MODULE_2__["default"].getView(_views_notfound_tpl_html__WEBPACK_IMPORTED_MODULE_4___default.a);
    var stateTreeView = _lib_viewsFactory__WEBPACK_IMPORTED_MODULE_2__["default"].getView(_views_statetree_tpl_html__WEBPACK_IMPORTED_MODULE_5___default.a);
    var stateCache = null;
    var delta = null; // Poll for store
      ...
      chrome.devtools.inspectedWindow.eval("window.__flowDownStores__ !== undefined ? window.__flowDownStores__.get(0).getState() : null", function (result, exceptionInfo) {
        if (result) {
          if (JSON.stringify(result) !== JSON.stringify(stateCache)) {
            delta = deep_diff__WEBPACK_IMPORTED_MODULE_0___default()(result, stateCache);
            stateCache = Object.assign({}, result);
            var str = JSON.stringify(result, null, 4);
            var status = JSON.stringify(delta, null, 4);
            ui.present(stateTreeView.render({
              payload: Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["highlightSyntax"])(str),
              status: status
            }));
          }
        } else {
